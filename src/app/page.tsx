    ...
    <div className="w-full min-h-screen rounded-xl bg-black p-4 m-1">
      <div className="flex flex-col md:flex-row w-full max-w-4xl mx-auto">
        ...
        <div className="w-full md:w-1/2 p-4 flex flex-col items-start mt-5">
          ...
          <p className="text-white mt-4">Room.me is an innovative video conference product that revolutionizes virtual meetings.</p>
          ...
          <div className="mt-6 w-full">
            <form className="w-full">
              ...
              <input 
                ...
                className="w-full p-3 mt-2 mb-3 text-white rounded-md border-2 border-gray-800 focus:outline-none focus:border-blue-500 bg-gray-900"
              />
              <label className="text-white font-semibold">Password</label>
              <input 
                type="password" 
                placeholder="Enter your password"
                className="w-full p-3 mt-2 text-white rounded-md border-2 border-gray-800 focus:outline-none focus:border-blue-500 bg-gray-900"
              />
              <button 
                type="button" 
              ...
              <div className="w-full flex justify-center mt-6">
                <p className="text-white text-center">
                  Doesn’t have an account? <span className="font-bold underline cursor-pointer">Sign Up</span>
                </p>
              </div>
            </form>
          </div>
